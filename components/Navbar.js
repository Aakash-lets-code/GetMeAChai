...
const Navbar = () => {
    ...
    return (
        <nav className='bg-gray-900 text-white flex items-center justify-between px-8 md:h-16 relative z-50 flex-col md:flex-row'>
            ...
            <div className='relative flex flex-col gap-3 md:block'>
                ...
                {!session && <Link href={"/login"}>
                    <button className='text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-1' >
                        Login
                    </button>
                </Link>}
            </div>
